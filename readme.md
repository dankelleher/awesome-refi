...
-  [Kolectivo](https://www.kolektivo.network/) - _Powering Regenerative Ecosystems_ 
A network building holistic solutions for a socio-environmental impact through tech, funding, and framework development.

## The technological infrastructure

### Building tools and protocols

- [Astral](https://astral.global/) - building tools for location-based decentralized web3 applications
- [The Regen Ledger](https://docs.regen.network/) - infrastructure for ecological assets and the verification of claims
- [Regen Commons](https://www.commonsstack.org/) - tools library rooted in community and cultural values
- [Prime DAO](https://www.prime.xyz/) - tools for launching and connecting DAOs
- [Spectre](https://spectre.xyz/) - fully liquid and permissionless public goods marketplace for digital art objects
- [Toucan Protocol](https://toucan.earth/) - infrastructure for digital carbon credit projects

### Chains for a positive impact

## On-chain carbon markets
Since Blockchain prove to be an ideal enabler of a well-functioning and effective carbon economy, Regenerative Finance has advanced rapidly thanks to projects developing on-chain carbon markets.

### Forestry-focused carbon tokens
...
- [The Regen Registry](https://regennetwork.notion.site/Welcome-to-Regen-Registry-0d55aab2a2d64f27aee2a468df172990)

### Marketplaces

- [Green Trade](https://greentrade.tech/)
- [Senken](https://www.senken.io/)
- [Carbonmark](https://www.carbonmark.com/)
- [KlimaDAO](https://app.klimadao.finance/#/offset)
- [Thallo.io](https://www.thallo.io/)
- [C3](https://www.c3.app/)
...
- [Dovu](https://app.dovu.market/)
- [MRV Collective](https://www.mrvcollective.org/)
- [Emerging](https://emerging.eco/) carbon tokenisation of household impact (demo)

### Impact explorers

- [Open Forest Protocol explorer](https://explorer.openforestprotocol.org/)
...
- [Crypto Events by Crypto Nomad Club](https://docs.google.com/spreadsheets/d/1KtyFTb_W282bQ1xoVA5rlTwTDz3QfhswWIVpXhpbQIc/edit#gid=696686482)
- [Events](https://www.refidao.com/ecosystem/events) on the ReFi DAO platform
- [Regens Unite events](https://www.regensunite.earth/#events)
...
- [ReFi DAO Podcast](https://podcast.refidao.com/)
- Green Pill podcast by Kevin Owocki [on podcast platforms](https://pod.link/1609313639) and [YouTube](https://www.youtube.com/@Green_Pill_Podcast)
- Crypto Altruism [Podcast](https://www.cryptoaltruism.org/podcast)

### Blogs

- [ReFi DAO content](https://www.refidao.com/ecosystem/content)
- [Toucan Protocol blog](https://blog.toucan.earth/)
- [Crypto Altruism](https://www.cryptoaltruism.org/)
- [Celo Blog](https://blog.celo.org/)
- [Curve Labs Blog](https://blog.curvelabs.eu/)

### Newsletters

[DeCarbonized](https://blog.toucan.earth/tag/decarbonized/) by Toucan Protocol
[Web3forGood](https://web3forgood.substack.com/) - a weekly newsletter 

### Books

- [_Regens Unite handbook_](https://opencollective.com/regensunite/projects/regensunite-handbook)
- Free downloadables from [Green Pill](https://greenpill.network/#book) 
  * _GreenPilled. How Crypto Can Regenerate The World_
  * _ImpactDAOs. Web3 Projects With Positive Impact On The World_
  * _Stuff That Crypto OGs Should Know_
  * _The Future History Of The Open Internet_
  * _Ethereum For Public Goods_ (a comic book)
- [_Regenerative Enterprise. Optimizing for Multi-capital Abundance_](https://regenterprise.com) by Ethan Roland and Gregory Landua
- [_Regenerative Capitalism. How Universal Principles And Patterns Will Shape Our New Economy_](https://capitalinstitute.org/regenerative-capitalism/) by John Fullerton (whitepaper)
- [_Doughnut Economics: Seven Ways to Think Like a 21st-Century Economist_](https://www.kateraworth.com/) by Kate Raworth
- [_The Impact DAO book_](https://impactdaos.xyz/) - a guide to impact DAOs
- [_The Network State_](https://thenetworkstate.com/)
...
- [The Regen Foundation](https://regen.foundation/#)
- [Loa Labs](https://loalabs.io/)
- [Green Pill quadratic funding round](https://docs.google.com/document/d/1obNKrnOQBECtCGL8-73a6ArKmPPHP2GMrMoPlskUJZM/edit#heading=h.rf0clybktw6t)
- [Cubik - quadratic funding platform on Solana](https://www.cubik.so/)
- [Gitcoin](https://explorer.gitcoin.co/#/)
- [Retroactive Funding](https://app.optimism.io/retropgf) for public goods on Optimism
- [Cerulean Ventures](https://cerulean.vc/)
- [Drips network](https://www.drips.network/) for open-source projects
- [Artizen](https://help.artizen.fund/en/) matching fund for art, science, technology, and design
...
- [Endoament](https://endaoment.org/)
- [Give Directly](https://www.givedirectly.org/crypto/) using crypto

### for real-world impact organisations 

- [Vlinder Climate](https://web3.vlinderclimate.com/)
- [Ivy Protocol](https://www.ivyprotocol.com/) funding for pre-certified environmental projects
- [EthicsHub](https://www.ethichub.com/en) - a crowdlending platform to invest in small producers and farmers

## Regenerative participation opportunities

### For everyone
[Return](https://www.return.green/) - _Build your digital identity, save the planet_

### For projects and communities 

- Join or create a [local chapter](https://greenpill.network/#network) with Green Pill network.
- An [open call](https://cryptoforinnovation.org/tell-your-story-of-crypto-in-action-open-call-for-case-studies/) by Crypto Council for Innovation for case studies on crypto, web3, and positive impact projects

### For investors, industry experts, and business devs (private sector)

- [An open call for alternative carbon standards](https://share-eu1.hsforms.com/1AvZ1GKQ7TIOm2TBntuxFFgfhhlr) KlimaDAO for the supply side of carbon market stakeholders
- [Crypto Climate Accord](https://cryptoclimate.org/) private-sector-driven development of open-source solutions and good practices to decarbonize the crypto industry
- [OpenEarth donations](https://www.openearth.org/donations)
- [ClimateCoin](https://www.climatecoin.io/) (in development)
- [BICO2 Working Group](https://bicowg.org/about-us/)
